...
def main():
    parser = argparse.ArgumentParser(
        description="Track layerwise embedding shifts for LayerNorm GNN and same-depth LayerNorm MLP baselines."
    )
    ...
    parser.add_argument(
        "--out-root",
        type=str,
        default="./__saved__/analysis/layernorm_embedding_tracking",
    )
