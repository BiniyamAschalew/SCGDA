...
\begin{figure}[t]
\centering
\IfFileExists{src/model_figure.pdf}{\includegraphics[width=\textwidth]{src/model_figure.pdf}}{\fbox{\rule{0pt}{2.1in}\rule{0.95\textwidth}{0pt}}}
...
\paragraph{Results.}
Table~\ref{table:evaluation} shows ...
\input{src/eval_table.tex}
